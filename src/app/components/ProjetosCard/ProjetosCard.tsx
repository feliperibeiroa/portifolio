...
export const ProjetosCard = ( projeto  : ProjetosCardProps) => {
    return (
        <div className="hover:scale-105 transition-transform duration-300 card w-80 border-[#ad31ad] border-2 bg-[#361833] p-5 rounded-2xl flex flex-col gap-5 shadow-2xl text-white">
