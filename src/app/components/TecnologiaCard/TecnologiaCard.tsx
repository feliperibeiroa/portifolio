...
export const TecnologiaCard = ( tecnologia : TecnologiaProps) => {
  return (
    <div className="tecnologia-card flex justify-center items-center min-w-32 flex-col gap-2 text-white border-[2.5px] select-none border-[#ad31ad] bg-[#3f143f] hover:bg-[#5c1d5c] rounded-2xl p-4">
